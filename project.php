...
<div class="projectTitle bootstrap">
	<h1>This is Project Title<br/>
	<small>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iste, quas aspernatur ipsam numquam magnam minima officia nesciunt deleniti sunt impedit!</small>
	</h1>
</div>
...
<div class="project">
	...
	<div class="rightPanel right">
		...
		<div class="stages aspiration">Aspiration</div>
		...
		<div class="bootstrap">
			<button type="button" class="btn btn-success like">
				...
				<span class="likeIt"> I Like It</span>
			</button>
				...
				<div class="people">
					<div class="peopleInfo right">
						<div class="peopleInfos">
							...
							<span class="name"> Kayden Gerard </span>
						</div>
					</div>
					<div class="profileImg">
						<img src="images/profile/tempProfile2.jpg" alt="profilePic" />
					</div>			
				</div>
			</a>
		</div>
				...
				<div class="people">
					<div class="peopleInfo right">
						<div class="peopleInfos">
							...
							<span class="name"> Laureen Noeleneeeee </span>
						</div>
					</div>
					<div class="profileImg">
						<img src="images/profile/tempProfile1.jpg" alt="profilePic" />
					</div>					
				</div>
			</a>
		</div>
			...
			<a href="#">
				<div class="people">
					<div class="peopleInfo right">
						<div class="peopleInfos">
							<span class="position">Team member </span><br/>
							<span class="name"> Dean Jasper </span>
						</div>
					</div>
					<div class="profileImg">
						<img src="images/profile/tempProfile3.jpg" alt="profilePic" />
					</div>
				</div>
			</a>
		</div>
